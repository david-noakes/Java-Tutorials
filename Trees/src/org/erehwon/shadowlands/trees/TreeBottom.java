...
public class TreeBottom {
       ...
       int[] treeBottom(String tree) {
         ...
         //tree = tree.substring(1+parts[1].length(), tree.length() - 1)

 

//       System.out.println("About to call traverseLeft");
...
//       System.out.println("About to call traverseRight idx="+forest.srcIdx);
         ...
         while ((forest.srcIdx < forest.source.length -1)) {
                ...
                if (parts[forest.srcIdx].startsWith("))") && parts[forest.srcIdx].length() > 2 ) {
...
//       System.out.println("About to call Add To Tree");
       ...
       HashMap traverseLeft(HashMap map, String tree, int depth, BinaryTree forest, Node currNode) {
...
//                System.out.println("traverseLeft early exit idx=" + forest.srcIdx);
       ...
       HashMap traverseRight(HashMap map, String tree, int depth, BinaryTree forest, Node currNode) {
       ...
       //         System.out.println("traverseRight short exit idx=" + forest.srcIdx + ": " +      parts[forest.srcIdx]);
